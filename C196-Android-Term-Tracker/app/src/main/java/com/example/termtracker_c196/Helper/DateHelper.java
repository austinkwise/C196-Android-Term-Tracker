...
public class DateHelper {
    ...
    public static long getDateTimestamp(String dateInput) {
        try {
            Date date = DateHelper.dateTimeFormat.parse(dateInput + TimeZone.getDefault().getDisplayName());
            return date.getTime();
        }
    ...
    public static long getDate(String dateInput) {
        try {
            Date date = DateHelper.dateFormat.parse(dateInput + TimeZone.getDefault().getDisplayName());
