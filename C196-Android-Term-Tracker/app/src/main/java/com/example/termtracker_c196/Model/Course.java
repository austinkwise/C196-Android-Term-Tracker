...
public class Course {
    ...
    public Course(Integer id, String termId, String title, String status, String startDate, Integer startDateAlert, String endDate, Integer endDateAlert, String assessmentsId, String notesId, String mentors, Integer alertCode) {
        this.id = id;
        this.termId = termId;
        this.title = title;
        this.status = status;
